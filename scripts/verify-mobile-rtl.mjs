...
console.log("Mobile RTL verified: Dari/Pashto use RTL screen direction, right-aligned text, reversed horizontal flows, mirrored navigation icons, and RTL tab order while English remains LTR.");
